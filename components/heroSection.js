  ...
  return (
    <section className='hero__area-3'>
          ...
          <div className='col-xxl-12'>
            <div className='hero__inner-3'>
              <div className='sec-title-wrapper'>
                ...
                <h3 className='sec-title title-left'>Digi</h3>
                <h3 className='sec-title title-right'>tarios</h3>
              </div>
              ...
              <div className='scroll-down'>
                <button>
                  <img src='/imgs/icon/arrow-down-sm.png' alt='arrow icon' />
                </button>
              </div>
            </div>
          </div>
      ...
      <div className='hero3-img-ani'>
        <img src='/imgs/hero/3/1.jpg' alt='Hero Image' className='hero3-img' />
      </div>
    </section>
  )
}
